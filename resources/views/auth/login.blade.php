		...
		<div class="tab-content auth_tab_content">
			...
			<div role="tabpanel" class="tab-pane" id="tab2">
				...
				<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
					...
					<div class="form-group">
						<div class="col-md-12">
							<label class="control-label clinics_form_label">Projected Graduation Year:</label>
							<input type="text" class="form-control input-lg" name="projected_graduation_year" value="{{ old('projected_graduation_year') }}">
						</div>
					</div>
